  ...
  "node_modules/@tamagui/collection/dist/cjs/Collection.js"(exports, module2) {
    ...
    function createCollection2(name) {
      ...
      const ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-collection-item", CollectionItemSlot = import_react44.default.forwardRef((props, forwardedRef) => {
        const { __scopeCollection, children, ...itemData } = props, ref = import_react44.default.useRef(null), composedRefs = (0, import_compose_refs17.useComposedRefs)(forwardedRef, ref), context = useCollectionContext(__scopeCollection);
...
var PopperArrow = PopperArrowFrame.styleable(function(propsIn, forwardedRef) {
  ...
  if (primaryPlacement) {
    ...
    oppSide && (arrowStyle[oppSide] = -size2, innerArrowStyle[oppSide] = size2 / 2), oppSide === "bottom" && (arrowStyle[oppSide] += 1), (oppSide === "top" || oppSide === "bottom") && (arrowStyle.left = 0), (oppSide === "left" || oppSide === "right") && (arrowStyle.top = 0), (0, import_core24.useIsomorphicLayoutEffect)(() => {
      var _a2;
